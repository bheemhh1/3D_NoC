...
#define AreaDFF         (9.36) 
#define AreaMUX2        (3.6)  
#define AreaMUX3        (9.36 * SCALE_T) /*old value*/
#define AreaMUX4        (12.6 * SCALE_T) /*old value*/

#elif(PARM(TECH_POINT) == 45)
#define AreaNOR      (.7056)   
#define AreaINV     (.5292)  
#define AreaDFF     (5.1156) 
#define AreaAND     (1.0584)  
#define AreaMUX2    (1.764)  
#define AreaMUX3    (2.998) 
#define AreaMUX4    (4.2336) 
