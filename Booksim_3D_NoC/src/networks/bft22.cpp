...
Bft22::Bft22( const Configuration& config, const string & name )
: Network ( config, name )
{
  _ComputeSize( config );
  _Alloc( );
...
void Bft22::_ComputeSize( const Configuration& config )
{
...
void Bft22::RegisterRoutingFunctions(){

}

void Bft22::_BuildNet( const Configuration& config )
{
cout<<"BFat Tree"<<endl;
...
Router*& Bft22::_Router( int height, int pos )
{
  assert( height < _n );
  ...
  /*
int Bft22::_WireLatency( int height1, int pos1, int height2, int pos2 )
{
