...
Bft21::Bft21( const Configuration& config, const string & name )
: Network ( config, name )
{
  _ComputeSize( config );
  _Alloc( );
...
void Bft21::_ComputeSize( const Configuration& config )
{
...
void Bft21::RegisterRoutingFunctions(){

}

void Bft21::_BuildNet( const Configuration& config )
{
cout<<"BFat Tree"<<endl;
...
Router*& Bft21::_Router( int height, int pos )
{
  assert( height < _n );
  ...
  /*
int Bft21::_WireLatency( int height1, int pos1, int height2, int pos2 )
{
