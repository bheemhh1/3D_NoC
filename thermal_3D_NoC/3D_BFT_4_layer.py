...
for z in range(layers):
	...
	fplan.write('Fill_1_0_'+str(z)+'\t0.01107\t0.00302\t'+str(0.00000)+'\t'+str(0.01391)+'\n')
	fplan.write('Fill_1_1_'+str(z)+'\t0.01107\t0.00302\t'+str(0.01373)+'\t'+str(0.01391)+'\n')
	
	if(z!=layers-1):
		fplan.write('Router_2_0_'+str(z)+'\t0.001330\t0.001330\t'+str(0.01107)+'\t'+str(0.01409)+'\n')
		fplan.write('TSV_2_0_'+str(z)+'\t0.001330\t0.000180\t'+str(0.01107)+'\t'+str(0.01391)+'\n')
			
		fplan.write('Router_2_1_'+str(z)+'\t0.001330\t0.001330\t'+str(0.01107)+'\t'+str(0.0156)+'\n')
		fplan.write('TSV_2_1_'+str(z)+'\t0.001330\t0.000180\t'+str(0.01107)+'\t'+str(0.01542)+'\n')
		
		timtsv.write('TIM_unit_2_0_'+str(z)+'\t0.001330\t0.001330\t'+str(0.01107)+'\t'+str(0.01409)+'\n')
		timtsv.write('TIM_tsv_2_0_'+str(z)+'\t0.001330\t0.000180\t'+str(0.01107)+'\t'+str(0.01391)+'\n')
			
		timtsv.write('TIM_unit_2_1_'+str(z)+'\t0.001330\t0.001330\t'+str(0.01107)+'\t'+str(0.0156)+'\n')
		timtsv.write('TIM_tsv_2_1_'+str(z)+'\t0.001330\t0.000180\t'+str(0.01107)+'\t'+str(0.01542)+'\n')
			
		timtsv.write('TIM_unit_2_2_'+str(z)+'\t0.001330\t0.001330\t'+str(0.0124)+'\t'+str(0.01409)+'\n')
		timtsv.write('TIM_tsv_2_2_'+str(z)+'\t0.001330\t0.000180\t'+str(0.0124)+'\t'+str(0.01391)+'\n')
			
		timtsv.write('TIM_unit_2_3_'+str(z)+'\t0.001330\t0.001330\t'+str(0.0124)+'\t'+str(0.0156)+'\n')
		timtsv.write('TIM_tsv_2_3_'+str(z)+'\t0.001330\t0.000180\t'+str(0.0124)+'\t'+str(0.01542)+'\n')

		timtsv.write('Filler_1_0_'+str(z)+'\t0.01107\t0.00302\t'+str(0.00000)+'\t'+str(0.01391)+'\n')
		timtsv.write('Filler_1_1_'+str(z)+'\t0.01107\t0.00302\t'+str(0.01373)+'\t'+str(0.01391)+'\n')
	
	else:
		fplan.write('Fill_2_0_'+str(z)+'\t0.001330\t0.00302\t'+str(0.01107)+'\t'+str(0.01391)+'\n')
			
	if(z!=0):
		fplan.write('Router_2_2_'+str(z)+'\t0.001330\t0.001330\t'+str(0.0124)+'\t'+str(0.01409)+'\n')
		fplan.write('TSV_2_2_'+str(z)+'\t0.001330\t0.000180\t'+str(0.0124)+'\t'+str(0.01391)+'\n')
			
		fplan.write('Router_2_3_'+str(z)+'\t0.001330\t0.001330\t'+str(0.0124)+'\t'+str(0.0156)+'\n')
		fplan.write('TSV_2_3_'+str(z)+'\t0.001330\t0.000180\t'+str(0.0124)+'\t'+str(0.01542)+'\n')
		
	else:
		fplan.write('Fill_2_1_'+str(z)+'\t0.001330\t0.00302\t'+str(0.0124)+'\t'+str(0.01391)+'\n')
